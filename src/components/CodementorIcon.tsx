...
interface CodementorIconProps {
	size?: number;
	color?: string;
	className?: string;
}

export function CodementorIcon({
	size = 20,
	color,
	className,
}: CodementorIconProps) {
