  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name='description'
          content='Software engineer and tech leader sharing insights on engineering, AI, and technology. Read my latest thoughts and experiences.'
        />
        <meta
          property='og:title'
          ...
          <SimpleGrid columns={{ base: 1, lg: 2 }} gap={12} alignItems='center'>
            <VStack align='start' gap={6} textAlign='left'>
              <Box>
                ...
                <Text fontSize='xl' color={muted} mb={6} lineHeight={1.6}>
              ...
              <HStack gap={3} wrap='wrap'>
                <Tag.Root size='md' variant='solid' bg='blue.500' color='white'>
                  TypeScript
                </Tag.Root>
                <Tag.Root
                  size='md'
            ...
            <Box textAlign='center'>
              ...
              >
                <Avatar.Image
                  ...
                  alt='Nick Karnik'
                />
                <Avatar.Fallback fontSize='4xl' bg='blue.500' color='white'>
                  NK
                </Avatar.Fallback>
              </Avatar.Root>
      ...
      {/* Stats Section */}
      <Box mb={16}>
        <Heading size='xl' textAlign='center' mb={10} color='gray.800'>
        ...
        <SimpleGrid columns={{ base: 1, md: 3 }} gap={8}>
          ...
          >
            <Text fontSize='sm' color={muted} mb={2} fontWeight='medium'>
              Years Experience
            </Text>
          ...
          >
            ...
            <Heading size='2xl' color='purple.600' mb={1}>
              5+
            </Heading>
            <Text fontSize='sm' color={muted}>
              Engineering Teams
        ...
        <SimpleGrid columns={{ base: 1, md: 2, lg: 3 }} gap={8}>
          ...
          >
            <HStack mb={4}>
              ...
              >
                <FiCode color='blue.600' size={24} />
              </Box>
              <Heading size='lg'>Full-Stack Development</Heading>
            </HStack>
            <Text color={muted} mb={4} lineHeight={1.6}>
          ...
          >
            <HStack mb={4}>
              <Box
                ...
                justifyContent='center'
              >
                <FiUsers color='green.600' size={24} />
              </Box>
          ...
          >
            <HStack mb={4}>
              <Box
                ...
                justifyContent='center'
              >
                <FiTrendingUp color='purple.600' size={24} />
              </Box>
      ...
      <Card.Root
        ...
        mb={16}
      >
        <Heading size='xl' textAlign='center' mb={8} color='gray.800'>
          Currently
        </Heading>
      ...
      <Box mb={16}>
        <Box textAlign='center' mb={10}>
          ...
          <Text fontSize='lg' color={muted} maxW='2xl' mx='auto'>
      ...
      <Box mb={16}>
        ...
        <SimpleGrid columns={{ base: 1, md: 3 }} gap={8}>
          ...
          >
            ...
            <Text color={muted} mb={6} lineHeight={1.6}>
