...
window.MayaSave=MayaSave;
  ...
  function save(){
    MayaSave.set('gardenwork_save', JSON.stringify(GW.state));
  }
  function load(){
    try{ var r=MayaSave.get('gardenwork_save'); return r?JSON.parse(r):null; }catch(e){ return null; }
  }
  GW.save=save;
  ...
  $('#resetBtn').addEventListener('click',function(){
    ...
    MayaSave.remove('gardenwork_save');
